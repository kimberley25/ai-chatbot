...
def load_system_prompt(file_path=None, prompt_dir=None):
    """Load system prompt from either a directory of numbered text files or a single file for backward compatibility."""
